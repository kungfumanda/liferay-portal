...
package com.liferay.portal.search.web.internal.modified.facet.portlet.display.template;
...
public class ModifiedFacetPortletDisplayTemplateHandler
	...
	public String getName(Locale locale) {
		...
		return _language.format(
			...
			_portal.getPortletTitle(
				ModifiedFacetPortletKeys.MODIFIED_FACET, resourceBundle),
			false);
	}

	@Override
	public String getResourceName() {
		return ModifiedFacetPortletKeys.MODIFIED_FACET;
	}
	...
	public Map<String, TemplateVariableGroup> getTemplateVariableGroups(
		...
		templateVariableGroup.addVariable(
			"modified-facet-display-context", ModifiedFacetDisplayContext.class,
	...
	protected String getTemplatesConfigPath() {
		return "com/liferay/portal/search/web/internal/modified/facet/portlet" +
