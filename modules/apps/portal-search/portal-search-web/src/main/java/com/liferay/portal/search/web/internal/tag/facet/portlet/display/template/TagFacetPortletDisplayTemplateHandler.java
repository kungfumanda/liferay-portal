...
public class TagFacetPortletDisplayTemplateHandler
	...
	public String getClassName() {
		return TagSearchFacetDisplayContext.class.getName();
	}
	...
	public Map<String, TemplateVariableGroup> getTemplateVariableGroups(
		...
		templateVariableGroup.addVariable(
			"tag-facet-display-context", TagSearchFacetDisplayContext.class,
			"tagSearchFacetDisplayContext");
		templateVariableGroup.addVariable(
	...
	protected String getTemplatesConfigPath() {
		return "com/liferay/portal/search/web/internal/tag/facet/portlet" +
