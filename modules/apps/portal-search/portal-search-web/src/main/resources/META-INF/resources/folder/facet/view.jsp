	...
	<c:otherwise>
		<aui:form action="#" method="post" name="fm">
			...
			<liferay-ddm:template-renderer
				...
				entries="<%= folderSearchFacetDisplayContext.getFolderBucketDisplayContexts() %>"
			>
					...
					>
						<aui:fieldset>
							<ul class="list-unstyled">
								...
								for (BucketDisplayContext bucketDisplayContext : folderSearchFacetDisplayContext.getFolderBucketDisplayContexts()) {
									i++;
								%>
